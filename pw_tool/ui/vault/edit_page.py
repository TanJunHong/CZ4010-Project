...
class EditPage:
    def __init__(self, master, website, value):
        ...
        self.__username_label = tkinter.ttk.Label(master=self.__inner_frame, text="Username:",
                                                  font=pw_tool.helper.ui_helper.font,
                                                  background=pw_tool.helper.ui_helper.background_color)
        self.__username_entry = tkinter.ttk.Entry(master=self.__inner_frame, font=pw_tool.helper.ui_helper.font)
        self.__username_entry.insert(index=0, string=self.__value["username"])
        self.__password_label = tkinter.ttk.Label(master=self.__inner_frame, text="Password:",
                                                  font=pw_tool.helper.ui_helper.font,
                                                  background=pw_tool.helper.ui_helper.background_color)
        self.__password_entry = tkinter.ttk.Entry(master=self.__inner_frame, font=pw_tool.helper.ui_helper.font)
        ...
        self.__edit_button.pack(padx=5, pady=5)
